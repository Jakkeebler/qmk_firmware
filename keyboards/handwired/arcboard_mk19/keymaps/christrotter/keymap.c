...
const ledmap ledmaps[] = {
    [_QWERTY]   = LEDMAP(
     RED, ORANGE, YELLOW, GREEN, CYAN, BLUE,     RED, GREEN, YELLOW, GREEN, CYAN, BLUE,
     RED, ORANGE, YELLOW, GREEN, CYAN, BLUE,     RED, ORANGE, YELLOW, GREEN, CYAN, BLUE,
     RED, ORANGE, YELLOW, GREEN, CYAN, BLUE,     RED, ORANGE, YELLOW, GREEN, CYAN, BLUE,
     RED, ORANGE, YELLOW, GREEN, CYAN, BLUE,     RED, ORANGE, YELLOW, GREEN, CYAN, BLUE,
     RED, ORANGE, YELLOW, GREEN, CYAN, BLUE,     RED, ORANGE, YELLOW, GREEN, CYAN, BLUE,
     RED, ORANGE, YELLOW, GREEN, CYAN, BLUE, PURPLE, PURPLE,     RED, ORANGE, YELLOW, GREEN, CYAN, BLUE, PURPLE, PURPLE
   ),
//    [_QWERTY]   = LEDMAP(
